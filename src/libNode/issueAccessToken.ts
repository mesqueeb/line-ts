 ...
 */
export async function issueAccessToken (params: IssueAccessTokenParams): Promise<IssueAccessTokenResponse> {
	const {
	...
	const { body }: { body: { data: IssueAccessTokenResponse } } = await got
